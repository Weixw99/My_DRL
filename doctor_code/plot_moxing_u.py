...
predicted_100step0 = np.load('E:/pycharm2018/project/circle_0427zaixian/run_0/saved_forwardsim/predicted_100step3.npy')  ###[101,2000,8]
...
lab, = plt.plot(x*0.1,val_u,color="black",linewidth=1)

#pred_x2 = pred2[:,0]
#pred_y2 = pred2[:,1]

pred01, = plt.plot(x*0.1,pred_u1,color="red",linewidth=2,linestyle='--')
