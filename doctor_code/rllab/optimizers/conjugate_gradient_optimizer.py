...
class ConjugateGradientOptimizer(Serializable):
    ...
    def optimize(self, inputs, extra_inputs=None, subsample_grouped_inputs=None, acceptViolation=True):

        self._accept_violation = acceptViolation ##### Anusha added this variable
