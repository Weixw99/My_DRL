...
list_new_loss = np.load('E:/pycharm2018/project/circle_0326_yanzheng/run_1/losses/list_new_loss.npy')
list_old_loss = np.load('E:/pycharm2018/project/circle_0326_yanzheng/run_1/losses/list_old_loss.npy')

list_training_loss = np.load('E:/pycharm2018/project/circle_0326_yanzheng/run_1/losses/list_training_loss.npy')

print("list_new_loss为：",list_new_loss)  # [0]
print("list_new_loss.shape为：",list_new_loss.shape) # (1,)

print("list_old_loss为：",list_old_loss)  # 0  同上
print("list_old_loss.shape为：",list_old_loss.shape)

print("list_training_loss为：",list_training_loss)  # 0
print("list_training_loss.shape为：",list_training_loss.shape)  # 同上
