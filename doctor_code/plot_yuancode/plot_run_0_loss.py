...
list_new_loss = np.load('E:/pycharm2018/project/circle_0411zaixian/run_0/losses/list_new_loss.npy')
list_old_loss = np.load('E:/pycharm2018/project/circle_0411zaixian/run_0/losses/list_old_loss.npy')

list_training_loss = np.load('E:/pycharm2018/project/circle_0411zaixian/run_0/losses/list_training_loss.npy')

epoch_training_losses = np.load('E:/pycharm2018/project/circle_0411zaixian/run_0/training_losses.npy')
...
print("epoch_training_losses为：",epoch_training_losses)  #
print("epoch_training_losses.shape为：",epoch_training_losses.shape)  # (480,)
