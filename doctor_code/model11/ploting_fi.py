...
ax.axis["新建2"].label.set_text("[rad]")
...
plt.plot(0.1*x,fi0[x],color="red",linewidth=1)
blue_line = mlines.Line2D([], [], color='blue',label=r'$\psi$'+str(num_aggregation_iters))
