...
A5, = plt.plot(x5,y5,color="blue",linewidth=3)
...
plt.legend([ D0,A1,A2,A3,A4,A5], ["Desire","True1","Ture2","Ture3","Ture4","Ture5" ])
# 于 offset 处新建一条纵坐标
#  offset = (40, 0)
#  new_axisline = ax.get_grid_helper().new_fixed_axis
...
D0, = plt.plot(x0,y0,color="black",linewidth=5,linestyle='--')
A6, = plt.plot(x6,y6,color="red",linewidth=4,linestyle='-')
