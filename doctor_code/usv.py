...
#    def update(self,ob):
        ...
        #C = np.array([[0, 0, -4.225 * x5 - 0.1375 * x6], [0, 0, 3.225 * x4], [4.225 * x5 + 0.1375 * x6, -3.225 * x4,  0]], float)
...
#####################zhuan matrix######
        ...
        disturbance = np.array([[0.3*np.cos(0.5*t)+0.1*np.sin(0.3*t)], [0], [0.1*np.sin(t)]])
#        disturbance = 0
        eta_dot=[]
        nu_dot=[]
        eta_dot = eta + dt * J * nu
