...
print("pred1为：",pred1)
print("pred1.shape为：",pred1.shape)
...
lab, = plt.plot(x*0.1,val_r,color="black",linewidth=1)

#pred_x2 = pred2[:,0]
#pred_y2 = pred2[:,1]

pred01, = plt.plot(x*0.1,pred_r1,color="red",linewidth=2,linestyle='--')
#pred02, = plt.plot(x*0.1,pred_r2,color="red",linewidth=2,linestyle='--')
#pred03, = plt.plot(x*0.1,pred_r1,color="red",linewidth=2,linestyle='--')
