...
datax_true=datax[m:len(pred_iter1[0])]

pred0=data_offline[:,m:len(pred_iter1[0]),:]
...
#e_offline=np.sqrt(np.multiply((x0-x_offline),(x0-x_offline)))
...
error_3, = plt.plot(0.1*pred1_,e_3,color="grey",linewidth=1)
