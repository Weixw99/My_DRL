...
def send_require(clientSocket):
    message2 = [3]
    message_json = json.dumps(message2, ensure_ascii=False)
    clientSocket.send(message_json.encode('UTF-8'))
...
if __name__ == '__main__':
    connection_string = '127.0.0.1:14560'  # /dev/serial0
    ...
    clientSocket.bind(('192.168.253.128', 9991))
